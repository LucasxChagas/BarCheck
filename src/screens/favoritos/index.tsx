    ...
    return (
        <View style={{ flex: 1 }}>
            <View>
                ...
                <FavItem title="The Spoilers Bar" desc="R. Artagnan Martins Réis, 161 - Jatiúca, Maceió - AL" cep="57036-050" rate="4.52" onPress={() => console.log('Nada...')}
                    backgroundColor={colors.background} borderColor={colors.accent} color={colors.text} colorDesc={colors.placeholder} href={require('../../assets/TheSpoilers.png')} />
            </View>
            <FAB
